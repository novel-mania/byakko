<template>
  <section class="section">
    <div class="container">
      <h1 class="title">
        <span>Recém chegadas</span>
        <svg width="31px" height="34px" class="title-icon">
      ...
      <div class="columns">
        ...
        <BaseAdvertinsing class="column is-narrow" type="square" />
      </div>
    </div>
  </section>
</template>
...
<script>
import BaseAdvertinsing from '~/components/base/BaseAdvertinsing';
import BaseCarousel from '~/components/base/BaseCarousel';
import BaseCarouselItem from '~/components/base/BaseCarouselItem';
